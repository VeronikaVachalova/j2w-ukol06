...
@GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    public Vizitka(Integer id, String celeJmeno, String firma, String ulice, String obec, String psc, String email, String telefon) {
        this.id = id;
    ...
    public void setCeleJmeno(String celeJmeno) { this.celeJmeno = celeJmeno;}
